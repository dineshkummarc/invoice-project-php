		...
		*/
		$lookupQuery = [
			'invoices' => [
				...
				'client_phone' => 'SELECT `clients`.`id`, `clients`.`phone` FROM `clients` ORDER BY 2',
				'client_email' => 'SELECT `clients`.`id`, `clients`.`email` FROM `clients` ORDER BY 2',
				'client_website' => 'SELECT `clients`.`id`, `clients`.`website` FROM `clients` ORDER BY 2',
				'client_comments' => 'SELECT `clients`.`id`, `clients`.`comments` FROM `clients` ORDER BY 2',
			],
			'clients' => [
			],
			'item_prices' => [
